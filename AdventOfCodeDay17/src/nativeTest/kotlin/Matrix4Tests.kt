...
class Matrix4Tests {
    ...
    fun createMatrixTest() {
        val lines = listOf(".#.","..#", "###" )
        val matrix = Matrix4.create(lines)
        ...
        val expectedW = 0..0
        val actualW = matrix.rangeW
        assertEquals(expectedW, actualW, "expectedW != actualW")
    }
    ...
    fun countNeighborsNotOnPointOnMatrixTest() {
        ...
        val expected = 0
        val actual = matrix.countTrueNeighbors(1000, 1000, 1000, 1000)
        assertEquals(expected, actual)
    }

    @Test
    fun neighborsTest() {
        val neighbors = Matrix4.generateNeighbors(0, 0, 0, 0)
    ...
    fun neighborsInMatrixTest() {
        ...
        val neighbors = matrix.getNeighbors(0, 0, 0, 0)
        val actual = neighbors.count()
        val expected = 8
        assertEquals(expected, actual)
    }
    ...
    fun countTrueNeighborsOfPointOnMatrixTest() {
        ...
        val expected1 = 5
        val actual1 = matrix.countTrueNeighbors(0, 0, 0, 0)
    ...
    fun printWithBadZisEmptyTest() {
        ...
        val actual = matrix.print(99, 99) // 99 for z is out of range
        val expected = ""
        assertEquals(expected, actual)
    }
    ...
    fun basicTransformTest() {
        ...
        val expectedRangeW = -1..1
        val actualRangeW = newMatrix.rangeW
        assertEquals(expectedRangeW, actualRangeW)
        ...
        val actualZ0Print = newMatrix.print(0, 0)
